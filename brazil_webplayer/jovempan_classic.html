...
<Html>
       ...
       <body>
             ...
             <!-- <video id="video" controls type="application/x-mpegURL"></video>-->
                  <audio controls>
                    <source src="https://sc1s.cdn.upx.com:8032/stream" type="audio/aac">
...
<script>
                      if(Hls.isSupported()) {
                        ...
                        var hls = new Hls();
                        hls.loadSource('http://live-y16rq9u0.rmbl.ws/slot-94/spwi-ylcz_360p/media-uwggh9nui_DVR_172494.ts');
