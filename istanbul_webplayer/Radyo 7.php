...
<script>
                      if(Hls.isSupported()) {
                        ...
                        var hls = new Hls();
                        hls.loadSource('https://moondigitaledge.radyotvonline.net/radyo7/playlist.m3u8?listeningSessionID=64cf845fe6cd8ce3_1394935_DYUO70IZ__0000000vhtd&downloadSessionID=0');
